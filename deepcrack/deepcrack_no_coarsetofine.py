...
class NoCoarseToFineUMamba(nn.Module):
    def __init__(self):
        super().__init__()
...
def main():
    ...
    model = NoCoarseToFineUMamba().to(device)
    ...
    save_dir = "/root/autodl-tmp/Demo2/deepcrack/checkpoints_deepcrack_no_coarse2fine_transfer"
    os.makedirs(save_dir, exist_ok=True)
    
    best_f1 = 0
    patience_counter = 0
    
    print("\n开始训练 No Coarse-to-Fine on DeepCrack...")
    ...
    print("\n" + "=" * 60)
    print("Exp-B: No Coarse-to-Fine on DeepCrack")
    print("=" * 60)
